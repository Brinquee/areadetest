...
script_bot.widget:setText('BRINQUE SCRIPTS - ' .. actualVersion)
script_bot.widget.statusLabel:setText('Pronto.')

-- Botão principal no painel
script_bot.buttonWidget = UI.Button(CUSTOM MOBILE(FREE)', function()
...
script_bot.buttonWidget:setColor('#36fd52ff')
